...
function criteria() { 
    ...
    if (state == true) {
        msg.innerHTML = 'Thank You :) Your Message has been submitted successfully. <br> You will hear form us very soon!';
...
function trigger(){
    document.getElementById('nav1').innerHTML = "this is testing one "
